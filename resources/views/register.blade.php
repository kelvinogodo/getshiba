...
<body>
    ...
    <header>
        ...
        <div class="menu-list" id="menu-items">
            ...
            <ul class="list-items">
                <li class="li">
                    <div class="bar"></div><a href="{{ route('index') }}">home <img
    ...
    <section class="landpage">
        ...
        <div class="welcome-text-container">
            <img src="{{ asset('data/images/sign-concept-illustration_114360-5375-removebg-preview.png') }}" alt=""
        ...
        <div class="landpage-card-container">
            ...
            <form action="" class="lanpage-form animate__animated animate__bounceInDown">
                ...
                <input type="text" name="name" id="" value="{{ old('name') }}" required class
                    {{ $errors->has('name') ? 'is-invalid' : '' }} placeholder="ENTER YOUR FULL NAME">
                ...
                <input type="text" name="E-mail" id="" value="{{ old('email') }}" required class
                    {{ $errors->has('email') ? 'is-invalid' : '' }} placeholder="ENTER YOUR E-MAIL ADDRESS">
                ...
                <input type="password" name="password" id="" required class
                ...
                <button class="submit-btn register-btn" type="submit">
            ...
            <p class="animate__animated animate__bounceInUp">already have an account ? <a
