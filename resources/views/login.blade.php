    ...
    <header>
      ...
      <section class="landpage">
        ...
        <div class="welcome-text-container">
            <img src="{{asset('data/images/images__2_-removebg-preview.png')}}" alt="" class="animate__animated animate__bounceInDown">
        </div>
        <div class="landpage-card-container">
          <h1 class="lanpage-form lanpage-form animate__animated animate__bounceInUp">login</h1>
          <form action="" class="lanpage-form lanpage-form animate__animated animate__bounceInUp">
          ...
          <p class="animate__animated animate__bounceInUp">forgot password ? <a href="#">create new</a></p>
          <p class="animate__animated animate__bounceInUp">don't have an account yet ? <a href="{{asset("register")}}">register</a></p>
        </div>
      </section>
      <footer>
