...
<body>
    ...
    <section class="landpage">
        ...
        <div class="welcome-text-container">
            <img src="{{ asset('data/images/images__2_-removebg-preview.png') }}" alt=""
        ...
        <div class="landpage-card-container">
            ...
            <p class="animate__animated animate__bounceInUp">don't have an account yet ? <a
                    href="{{ asset('register') }}">register</a></p>
        </div>
    </section>
    <footer>
