    ...
    <header>
      ...
      <section class="landpage">
        ...
        <div class="welcome-text-container">
            <img src="../images/images__2_-removebg-preview.png" alt="" class="animate__animated animate__bounceInDown">
        </div>
        <div class="landpage-card-container">
          ...
          <p class="animate__animated animate__bounceInUp">don't have an account yet ? <a href="./register.html">register</a></p>
        </div>
      </section>
      <footer>
